                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/kegiatan/lampiran/').$idPeriode.'/'.$row['id'] ?>" class="btn btn-success btn-xs">
                                        ...
                                        <?php if($row['status'] == 'Belum Terlaksana') { ?>
                                            <a href="<?= base_url('admin/kegiatan/delete/').$row['id'].'/'.$idPeriode ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Ingin menghapus data ini">
