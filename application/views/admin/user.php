    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/user/importexcel') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('assets/file_excel/example/import_manajemen_user.xlsx') ?>" class="btn btn-success pull-left"><div class="fa fa-download"></div> Template</a>
                    <button type="reset" class="btn btn-danger"><div class="fa fa-trash"></div> Reset</button>
                    <button type="submit" class="btn btn-primary"><div class="fa fa-save"></div> Import</button>
                </div>
            </form>
        </div>
    </div>
